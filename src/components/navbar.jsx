    ...
    <>
      ...
      >
        <Box sx={{ ...style, width: 400 }}>
          ...
          <Box>
            <Stack sx={{ my: 2 }}>
              <Button variant="outlined" sx={{ mb: 1 }} onClick={logout}>
                oui
              </Button>
            ...
            <div className={!open ? "subMenu" : "subMenu open"}>
              ...
              <nav className="nav_list">
                <ul className="navbar_nav">
                  ...
                  <li>
                    <FontAwesomeIcon icon="fa-solid fa-lightbulb" /> FAQ
                  </li>
                  <li> Boutique Forem</li>
                  <li>
                    <FontAwesomeIcon icon="fa-solid fa-heart" /> Commanditaires
                  </li>
                  <li>A propos de</li>
                  <li>
                    <FontAwesomeIcon icon="fa-solid fa-book-open" /> Contacter
                  </li>
                  <li>
                    <FontAwesomeIcon icon="fa-solid fa-book-open" /> Guides
                  </li>
                  ...
                  <li>
                    <FontAwesomeIcon icon="fa-solid fa-thumbs-up" /> Code de
                    conduite
                  </li>
                  <li>Politique de confidentialité</li>
                  <li>
                    <FontAwesomeIcon icon="fa-solid fa-tags" /> Conditions
                    d'utilisation
                  </li>
